    ...
    return(
        <div>
            ...
            <Informacion 
                ...
                Cúbrase la nariz y la boca al toser y estornudar con un pañuelo de papel desechable o con la parte interna del codo. Evitando el contacto directo (1 meto 3 pies) con cualquier persona con síntomas de resfriado."
            />
        </div>
    )   
}
